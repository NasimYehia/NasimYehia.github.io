...
const subtitles2 = [
  ...
  { start: 4, end: 6, text: "That means It has bedtime" },
  ...
  { start: 17, end: 19, text: "for to hurry up and go to sleep" },
  { start: 19, end: 23, text: "for As usual Henry does not" },
  ...
  { start: 36, end: 39, text: "while I think It has coming" },
  { start: 39, end: 42, text: "from my room" },
  { start: 42, end: 48, text: "while I am late because of you" },
